...
(function () {
    ...
    window.Evolv = function (options) {
        var intervalId,
            parents = [],
            beforeStart = function () { return; },
            afterFinish = function () { return; },
            beforeGeneration = function () { return; },
            afterGeneration = function () { return; },
        ...
        settings = {
            ...
            parents: options.parents || 5,
            children: options.children || 25
        };
        /**
        ...
        function createNextGeneration() {
            ...
            // create offspring
            for (i = 0; i < settings.children; i += 1) {
                // random selection
        ...
        function initialise() {
            var i, individual;
            parents = [];
            for (i = 0; i < settings.parents; i += 1) {
                individual = {};
